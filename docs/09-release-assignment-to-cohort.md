...
In the course org's `.github` → **Actions** → **Release assignment** (e.g. [Release assignment](https://github.com/hertie-demo-e1234/.github/actions/workflows/release-assignment.yml)). Pick the `course_source_repo` - the same field a scheduled handout names in `schedule.yml`.
...
---
**Demo:** per-student repos in [`hertie-demo-f2026`](https://github.com/hertie-demo-f2026).
