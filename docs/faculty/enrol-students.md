...
- A bootstrapped [cohort org](new-cohort-org.md) with the roster loaded in
...
- [Release to the cohort](release-to-cohort.md) - once students are onboarded, assignment
