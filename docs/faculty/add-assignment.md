...
- A bootstrapped [course org](new-course-org.md); you're in its `instructors` / `course-admin` team.
...
2. **Get write on the new repo** (same one-off grant as [materials](add-materials.md#steps), step 2).
...
- [Release to a cohort](release-to-cohort.md) - freeze + hand out per-student repos.
