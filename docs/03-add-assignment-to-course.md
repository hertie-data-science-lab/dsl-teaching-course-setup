...
1. **Scaffold the template.** 
   - In the course org → `.github` → **Actions tab** → [New assignment](https://github.com/hertie-demo-e1234/.github/actions/workflows/new-assignment.yml). Inputs:
...
---
**Demo:** [`hertie-demo-e1234`](https://github.com/hertie-demo-e1234) → New assignment.
