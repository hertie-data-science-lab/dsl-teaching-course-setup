<!-- SYSTEM-OWNED: this README, and the workflows under .github/, are regenerated by every
     "Bootstrap cohort" run AND by the nightly Refresh, so keep notes elsewhere - edits
     here will be overwritten. Every OTHER non-sample file in this repo is yours: the
     engine never rewrites students.csv, schedule.yml, people.yml, teams.csv or
     grades/*.csv once they exist. -->
