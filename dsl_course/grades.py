...
Usage:
    python3 -m dsl_course.grades sync       --cohort-org hertie-demo-f2026
    python3 -m dsl_course.grades render     --cohort-org hertie-demo-f2026
    python3 -m dsl_course.grades distribute --cohort-org hertie-demo-f2026
"""
